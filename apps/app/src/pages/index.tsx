		...
		<>
			...
			<section className='mx-auto my-52'>
				<div className='py-8 px-4 mx-auto my-8 max-w-screen-md text-center lg:py-16 lg:px-12'>
					...
					<h1 className='mb-4 text-4xl font-bold bg-gradient-to-r from-primary via-logo to-accent-light text-transparent bg-clip-text bg-300% animate-gradient tracking-tight leading-none lg:mb-6 md:text-5xl xl:text-6xl'>
						Under Construction
					</h1>
